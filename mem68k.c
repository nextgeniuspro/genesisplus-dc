...
{
    return m68k_read_memory_8f(address);
}

u32 FASTCALL m68k_read_memory_8f(const u32 addr)
{
    u32 address = addr & 0xFFFFFF;
...
{
    return m68k_read_memory_16f(address);
}

u32 FASTCALL m68k_read_memory_16f(const u32 addr)
{
    u32 address = addr & 0xFFFFFF;
...
{
    return m68k_read_memory_32f(address);
}

u32 FASTCALL m68k_read_memory_32f(const u32 address)
{
    /* Split into 2 reads */
...
{
    return m68k_write_memory_8f(address, value);
}

void FASTCALL m68k_write_memory_8f(const u32 addr, u32 value)
{
    u32 address = addr & 0xFFFFFF;
...
{
    return m68k_write_memory_16f(address, value);
}

void FASTCALL m68k_write_memory_16f(const u32 addr, u32 value)
{
    u32 address = addr & 0xFFFFFF;
...
{
    return m68k_write_memory_32f(address, value);
}

void FASTCALL m68k_write_memory_32f(const u32 address, u32 value)
{
    /* Split into 2 writes */
