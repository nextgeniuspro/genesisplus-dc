...
#ifdef GENS_FM
            YM2612_Update((int **)tempBuffer, snd.fm.curStage - snd.fm.lastStage);
            YM2612_DacAndTimers_Update((int **)tempBuffer, snd.fm.curStage - snd.fm.lastStage);
#else
